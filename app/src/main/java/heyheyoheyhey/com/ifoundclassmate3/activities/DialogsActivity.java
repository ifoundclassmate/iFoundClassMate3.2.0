...
public class DialogsActivity extends Activity {
    ...
    public void NewChat(View view) {
        startActivity(new Intent(DialogsActivity.this, FriendIDActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        heyheyoheyhey.com.ifoundclassmate3.activities.SplashActivity.logout();
        Intent intent = new Intent(DialogsActivity.this, HomeActivity.class);
        startActivity(intent);
        finish();
    }
}
